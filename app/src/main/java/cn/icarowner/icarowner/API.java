...
public class API {
    ...
    public static final String DEALER_DETAIL = "api/dealers/%s";//四S店详情
    public static final String DEALER_LIST = "api/groups/%s/dealers";//四S店列表
    ...
    public static final String OVERTIME_COMPENSATE_PRE_CALCULATION = "api/service/orders/%S/overtime_compensate";//超时赔付服务单赔付金额预估计算
    ...
    public static final String BALANCE_CHANGE_RECORD = "api/user/balance/movements";//余额变动记录
    ...
    public static final String APP_PAY = "api/payment/balance/app-pay";//0元支付
