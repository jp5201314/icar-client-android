 ...
 */
public abstract class EditTextDialog<T extends EditTextDialog<T>> extends BaseDialog<T> {
    /**
     * container
     */
    ...
    public void setUiBeforShow() {
        ...
        metContent.setTextSize(TypedValue.COMPLEX_UNIT_SP, mContentTextSize);
        metContent.setLineSpacing(0, 1.3f);
